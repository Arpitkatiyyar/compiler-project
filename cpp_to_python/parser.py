...
# # ------------------------------
# # Top-level program: a sequence of declarations and functions and main
# # ------------------------------
# def p_program(p):
...
#     # Represent main as a function named 'main' returning int with no params
...
#             | STRING
#             | VOID'''
#     p[0] = p.slice[1].type  # store token type string like 'INT'
...
#         # string literal alternative -- wrap as StringNode
#         val = StringNode(val)
#     p[0] = DeclarationNode(typ, name, val)

# # ------------------------------
# # Assignment (including increments, +=, -= handled in parser)
# # ------------------------------
...
# # for: support declaration init or assignment init
...
#     '''expression : TRUE
#                   | FALSE'''
#     # p[1] is lexeme 'true'/'false' or token; convert by token type check
#     val = True if p.slice[1].type == 'TRUE' else False
#     p[0] = BoolNode(val)
